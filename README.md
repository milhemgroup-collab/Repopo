...
- `PERPLEXITY_INSTRUCTIONS.md`: paste-ready Perplexity Personalization and Memory settings instructions, plus the Drive-to-Notion memory bridge
...
├── PERPLEXITY_INSTRUCTIONS.md   # Perplexity Personalization + Memory settings instructions
├── README.md                    # This file
